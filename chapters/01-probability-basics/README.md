...
### Problem 1:
You are rich. You want to invest a small portion of your money, say 10M $, in 4 companies. How many ways are there to allocate this money?

- **Python Solution:** [solutions/python/q1.py](solutions/python/q1.py)
- **R Solution:** [solutions/r/q1.R](solutions/r/q1.R)

### Problem 2:
Roll two 6-sided dice. What's the probability of the sum of shown numbers equals 7?
